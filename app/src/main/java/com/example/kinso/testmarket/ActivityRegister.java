    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        validateButton.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                ...
                // 1) 검증이 된 경우.
                if(validate){
                    Toast.makeText(ActivityRegister.this, "이미 ID check가 되었습니다.", Toast.LENGTH_SHORT).show();
                    return; //검증완료
                }
                // 정규표현식 숫자 8자리.
                ...
                // 4) 검증시작
                    ...
                    RequestValidate validateRequest = new RequestValidate(stdnum, responseListener);
        ...
        registerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                // 4) 전화번호 검사.
                    ...
                    RequestRegister registerRequest = new RequestRegister(stdnum, name, userGender, userMajor, userphone, userPassword, responseListener);
                    RequestQueue queue = Volley.newRequestQueue(ActivityRegister.this);
